		...
		<div class="container">
			...
			<div class="row">
		       ...
		       //database connection and retrive from db
				...
				$resultset = $mysqli->query("select * from mainportal order by mid desc ");
				
				?>
						<?php
						$resultse = $mysqli->query("select * from mainportal order by mid desc limit 1");
				
						
				while($rows=$resultse->fetch_assoc())
				{  
						
						
						$title = $rows['mtitle'];
						
					  echo "<h2 style= 'color:red;'><marquee scrollamount='12' width='100%' direction='left' height='100px'>
					  Latest News : $title.
						</marquee></h2>";
					}
						...
						<div class="col-md-6">
							<div class="footer-widget">
								...
								<ul class="footer-links">
									<li><a href="#">About Us</a></li>
									<li><a href="#">Join Us</a></li>
									<li><a href="loginsinup.html">Contacts</a></li>
								</ul>
							</div>
						</div>
						<div class="col-md-6">
