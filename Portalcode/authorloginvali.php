...
<head>
    ...
    <title>Author Login Error!404</title>
    <!-- Bootstrap -->
...
$retrive = "select  * from author where  email= '$email' && password='$password'";
...
{   
    ...
    echo "<div class='alert alert-success'><a href='author_login.php'> Try Login Again </a></div>";
