		...
		<div id="nav">
			...
			<div id="nav-fixed">
				<div class="container">
					...
					<li class='cat-1'><a href="#">News</a></li>
					...
					<div class="nav-btns">
						...
						<a href="home.php"><i class="fa fa-fw fa-user"></i> <?php echo"$name";  ?></a>
					</div>
					<!--  aside toggle -->
				</div>
			</div>
	...
	<!-- /Header -->
		   ...
		   <?php
		       //database connection and retrive from db
				...
				$resultset = $mysqli->query("select * from activearticle");
		...
		echo("
				...
				<div class='col-md-4'>
					<div class='post'>
						<a  class='post-img' href='viewpost.php?id=$id'><img height=328px width=1200px	 src='$imgsrc' alt=''></a>
						<div class='post-body'>
							<div class='post-meta'>
								<a class='post-category cat-1' href='viewpost.php?id=$id'>$catagory</a>
								<span class='post-date'>$publishdate</span>
							</div>
							<h3 class='post-title'>
							<a href='viewpost.php?id=$id'>$title</a></h3>
						</div>
					</div>
				</div>");
